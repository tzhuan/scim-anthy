...
#define SCIM_ANTHY_TRANS_CMD_SET_CONV_MODE         (SCIM_TRANS_CMD_USER_DEFINED + 11)
#define SCIM_ANTHY_TRANS_CMD_SET_TYPING_METHOD     (SCIM_TRANS_CMD_USER_DEFINED + 12)
#define SCIM_ANTHY_TRANS_CMD_SET_PERIOD_STYLE      (SCIM_TRANS_CMD_USER_DEFINED + 13)
#define SCIM_ANTHY_TRANS_CMD_SET_SYMBOL_STYLE      (SCIM_TRANS_CMD_USER_DEFINED + 14)

// transaction command from Helper to IMEngine
#define SCIM_ANTHY_TRANS_CMD_CHANGE_INPUT_MODE     (SCIM_TRANS_CMD_USER_DEFINED + 20)
#define SCIM_ANTHY_TRANS_CMD_CHANGE_CONV_MODE      (SCIM_TRANS_CMD_USER_DEFINED + 21)
#define SCIM_ANTHY_TRANS_CMD_CHANGE_TYPING_METHOD  (SCIM_TRANS_CMD_USER_DEFINED + 22)
#define SCIM_ANTHY_TRANS_CMD_CHANGE_PERIOD_STYLE   (SCIM_TRANS_CMD_USER_DEFINED + 23)
#define SCIM_ANTHY_TRANS_CMD_CHANGE_SYMBOL_STYLE   (SCIM_TRANS_CMD_USER_DEFINED + 24)
#define SCIM_ANTHY_TRANS_CMD_ATTACHMENT_SUCCESS    (SCIM_TRANS_CMD_USER_DEFINED + 25)
